...
typedef enum tVisTile {
	...
	VIS_TILE_TURRET_ACTIVE,
	VIS_TILE_TURRET_INACTIVE,
	VIS_TILE_TURRET_SHOOTING,

	VIS_TILE_BG_DECOR_BEGIN,
	VIS_TILE_BG_DECOR_CREATURE_1 = VIS_TILE_BG_DECOR_BEGIN,
