...
static const char *s_pLinesOutro[][LINES_PER_SLIDE_MAX] = {
	...
	},
	{
		...
		"They left a spell behind, allowing reaching the monstrosity,",
		"if a way of destroying it would be discovered.",
	},
	{
		"When I came back to my senses, I found myself back on the surface.",
		"The ancient structure was now completely destroyed and untraversable.",
		"No matter how hard I tried, I could not remember that ancient spell.",
	...
	},
	{
		...
		"The hopelessness and remorse were looming above me.",
		"Yet at the same time, I longed for power I discovered inside those ruins.",
		"I need to recover it, no matter the cost.",
		0,
	},
};
