...
typedef enum tTile {
	...
	TILE_WALL_NO_SLIPGATE      = 3  | TILE_LAYER_WALLS,
	TILE_WALL                  = 4  | TILE_LAYER_WALLS | TILE_LAYER_SLIPGATABLE,
	TILE_FORCE_FIELD           = 5  | TILE_LAYER_FORCE_FIELDS,
	...
	TILE_GATE_CLOSED           = 16 | TILE_LAYER_WALLS,
	TILE_GATE_OPEN             = 17,
	TILE_RECEIVER              = 18 | TILE_LAYER_WALLS,
	TILE_BOUNCER_SPAWNER       = 19 | TILE_LAYER_WALLS,
	TILE_SLIPGATABLE_OFF       = 20 | TILE_LAYER_WALLS,
	TILE_SLIPGATABLE_ON        = 21 | TILE_LAYER_WALLS | TILE_LAYER_SLIPGATABLE,
