...
typedef enum tTile {
	...
	TILE_TURRET_ACTIVE         = 26 | TILE_LAYER_WALLS | TILE_LAYER_ACTIVE_TURRET,
	TILE_UNUSED_1              = 27 | TILE_LAYER_WALLS | TILE_LAYER_ACTIVE_TURRET,
	TILE_TURRET_INACTIVE       = 28 | TILE_LAYER_WALLS,
	TILE_UNUSED_2              = 29 | TILE_LAYER_WALLS,
