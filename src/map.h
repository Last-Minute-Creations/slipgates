...
typedef enum tTile {
	...
	TILE_WALL_NO_SLIPGATE_1 = 3  | MAP_LAYER_WALLS,
	TILE_WALL_1             = 4  | MAP_LAYER_WALLS | MAP_LAYER_SLIPGATABLE,
	TILE_FORCE_FIELD_1      = 5  | MAP_LAYER_FORCE_FIELDS,
	TILE_DEATH_FIELD_1      = 6  | MAP_LAYER_LETHALS,
	TILE_EXIT_1             = 7  | MAP_LAYER_WALLS | MAP_LAYER_EXIT,
	TILE_BUTTON_1           = 8  | MAP_LAYER_WALLS | MAP_LAYER_BUTTON,
	TILE_BUTTON_2           = 9  | MAP_LAYER_WALLS | MAP_LAYER_BUTTON,
	TILE_BUTTON_3           = 10 | MAP_LAYER_WALLS | MAP_LAYER_BUTTON,
	TILE_BUTTON_4           = 11 | MAP_LAYER_WALLS | MAP_LAYER_BUTTON,
	TILE_BUTTON_5           = 12 | MAP_LAYER_WALLS | MAP_LAYER_BUTTON,
	TILE_BUTTON_6           = 13 | MAP_LAYER_WALLS | MAP_LAYER_BUTTON,
	TILE_BUTTON_7           = 14 | MAP_LAYER_WALLS | MAP_LAYER_BUTTON,
	TILE_BUTTON_8           = 15 | MAP_LAYER_WALLS | MAP_LAYER_BUTTON,
	TILE_GATE_1             = 16 | MAP_LAYER_WALLS,
	TILE_RECEIVER           = 17 | MAP_LAYER_WALLS,
	TILE_BOUNCER_SPAWNER    = 18 | MAP_LAYER_WALLS,
} tTile;
